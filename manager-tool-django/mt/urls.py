...
urlpatterns = [
    ...
    path("team/<int:member_id>/edit/", core_views.team_members_edit, name="team-edit"),
    ...
    path("events/<int:event_id>/uncomplete/", core_views.events_uncomplete, name="events-uncomplete"),
    path("events/<int:event_id>/complete-series/", core_views.events_complete_series, name="events-complete-series"),
    ...
    path("todos/<int:todo_id>/restore/", core_views.todos_restore, name="todos-restore"),
    path("todos/<int:todo_id>/edit/", core_views.todos_edit, name="todos-edit"),
    path("todos/<int:todo_id>/delegate/", core_views.todos_delegate, name="todos-delegate"),
    ...
    path("journal/<int:entry_id>/delete/", core_views.journal_delete, name="journal-delete"),
    ...
    path("goals/<int:goal_id>/status/", core_views.goal_status, name="goals-status"),
    ...
    path("delegations/<int:delegation_id>/complete/", core_views.delegations_complete, name="delegations-complete"),
    ...
    path("notes/<int:note_id>/edit/", core_views.notes_edit, name="notes-edit"),
    ...
    path("feedback/<int:feedback_id>/edit/", core_views.feedback_edit, name="feedback-edit"),
    ...
    path("export/", core_views.data_export, name="data-export"),
